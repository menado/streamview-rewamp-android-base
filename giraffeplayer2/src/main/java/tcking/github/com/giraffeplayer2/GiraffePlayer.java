...
public class GiraffePlayer implements MediaController.MediaPlayerControl {
     ...
     */
    private GiraffePlayer setVideoPath(String path) {
     ...
     */
    private GiraffePlayer setVideoURI(Uri uri) {
     ...
     */
    private GiraffePlayer setVideoURI(Uri uri, Map<String, String> headers) {
        this.uri = uri;
